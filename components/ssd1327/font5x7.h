/*
 * Bitmap-Schrift 5x7, ASCII 0x20 bis 0x7E, dazu die deutschen Umlaute in
...
/* Zusatzzeichen hinter dem ASCII-Bereich. */
enum {
    GLYPH_ae = 95, /* ä */
    GLYPH_oe,      /* ö */
    GLYPH_ue,      /* ü */
...
static const uint8_t font5x7[GLYPH_COUNT][FONT_W] = {
    ...
    /* Zusatzzeichen: Grundform mit Punkten in der obersten Zeile. */
    {0x20, 0x55, 0x54, 0x55, 0x78}, /* ä */
    {0x38, 0x45, 0x44, 0x45, 0x38}, /* ö */
    {0x3C, 0x41, 0x40, 0x21, 0x7C}, /* ü */
    {0x7E, 0x11, 0x49, 0x49, 0x36}, /* ß */
